  ...
  <div class="row col-11 mx-auto">
    ...
    <div class="row col-12 col-lg-10 mx-auto menu">
      <div class="col-12 col-md-3  menu-box">
        ...
        <button type="button" data-toggle="modal" data-target="#changement-de-titulaire" href="#Changement-de-titulaire" class="row col-10 mx-auto menu-commander--left color-categorie--2 color-categorie-7 d-flex align-items-center justify-content-center my-flex-container">
    ...
    <span class="col-12 menu-box--titre">
      ...
      <div class="col-12 col-md-3  menu-box">
        <button type="button" data-toggle="modal" data-target="#changement-de-statut-matrimonial" class="row col-10 mx-auto menu-commander color-categorie-3 d-flex align-items-center justify-content-center my-flex-container">
    ...
    <span class="col-12 menu-box--titre">            Changement de statut matrimonial</span>
      ...
      <div class="col-12 col-md-3  menu-box">
        <button type="button" data-toggle="modal" data-target="#justificatifs-de-domicile" class="row col-10 mx-auto menu-commander color-categorie-4 d-flex align-items-center justify-content-center my-flex-container">
    ...
    <span class="col-12 menu-box--titre">            Justificatifs de domicile</span>
      ...
      <div class="col-12 col-md-3  menu-box">
        <button type="button" data-toggle="modal" data-target="#mise-a-la-casse" class="row col-10 mx-auto menu-commander color-categorie-5 d-flex align-items-center justify-content-center my-flex-container">
    ...
    <span class="col-12 menu-box--titre">            Mise à la casse</span>
      ...
      <div class="col-12 col-md-3  menu-box">
        <button type="button" data-toggle="modal" data-target="#slucg" class="row col-10 mx-auto menu-commander color-categorie-6 d-flex align-items-center justify-content-center my-flex-container">
